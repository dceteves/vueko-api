    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Vueko Admin</h1>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-red-800">
                  Admin access required. You don't have permission to access this panel.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={() => login("osu")}
            className="w-full flex items-center justify-center px-4 py-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
          >
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
