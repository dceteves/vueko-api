...
import type { StrategyOptions, StrategyOptionsWithRequest } from 'passport-oauth2';
...
const fetchDiscordProfile = StrategyFactory.createProfileFunction<DiscordProfile>(userProfileURL);

const verifyDiscordProfile = StrategyFactory.createVerifyFunction<DiscordProfile>();

const verifyDiscordProfileWithRequest =
  StrategyFactory.createVerifyFunctionWithRequest<DiscordProfile>(UserService.linkDiscordProfile);
...
const DiscordStrategyWithRequest = StrategyFactory.createOAuth2StrategyWithRequest<DiscordProfile>(
